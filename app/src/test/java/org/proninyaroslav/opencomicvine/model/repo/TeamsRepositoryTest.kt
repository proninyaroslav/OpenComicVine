...
class TeamsRepositoryTest {
    ...
    @MockK
    lateinit var teamsList: List<TeamInfo>

    @Before
    fun setUp() {
        MockKAnnotations.init(this)

        repo = TeamsRepositoryImpl(comicVineService, apiKeyRepo)
    }

    @Test
    fun getTeamsList() = runTest {
        val apiKey = "123"
    ...
    @Test
    fun `getTeamsList API key error`() = runTest {
