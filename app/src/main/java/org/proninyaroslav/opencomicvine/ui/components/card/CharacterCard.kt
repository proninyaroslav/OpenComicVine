...
@Composable
private fun InnerCharacterCard(
    name: String,
    imageUrl: String?,
...
@Preview("Long name")
@Composable
fun PreviewCharacterCard_LongName() {
    OpenComicVineTheme {
        InnerCharacterCard(
...
@Composable
fun PreviewCharacterCard_NameOverflow() {
    OpenComicVineTheme {
        InnerCharacterCard(
...
@Composable
fun PreviewCharacterCard_Loading() {
    OpenComicVineTheme {
        InnerCharacterCard(
            name = "",
            imageUrl = null,
